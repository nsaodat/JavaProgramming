...
public class ScrumTeam {
    ...
    public void removeTester (int employeeID){
        testersList.removeIf(p-> p.employeeID == employeeID); // removeIf tester ID is matching with tester's ID
    }

    public void removeDeveloper (int employeeID){
        developersList.removeIf(p-> p.employeeID == employeeID); //removeIf developer ID is matching with developer's ID
    }
