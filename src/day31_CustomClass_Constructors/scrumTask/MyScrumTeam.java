...
public class MyScrumTeam {
    public static void main(String[] args) {
        ...
        ScrumTeam scrum = new ScrumTeam("Mike Tout", "Helen Roshford", "Neira", 14);

       // scrum.addDeveloper(developer1); // we can add one by one or use Array like in below example
        // scrum.addTester(tester1); // we can add one by one or use Array like in below example
